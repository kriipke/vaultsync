...
++++
<p align="center">
  <img width="275" height="275" src="icon.png">
</p>
<p align="center">
...
Download the latest release for your platform from the https://github.com/username/vaultsync/releases[releases page].
